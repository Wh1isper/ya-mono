...
- development infrastructure for `ya-agent-platform` lives under `packages/ya-agent-platform/dev/` with PostgreSQL and Redis compose assets plus matching env defaults
